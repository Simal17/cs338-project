...
db.run(sql);
importCSV("./data/user-sample.csv", "INSERT INTO User VALUES (?,?,?,?)");
...
db.run(sql);
importCSV("./data/product-sample.csv", "INSERT INTO Product VALUES (?,?,?,?,?,?,?)");
...
db.run(sql);
importCSV("./data/order-sample.csv", "INSERT INTO ProductOrder VALUES (?,?,?,?,?,?,?,?)");
...
db.run(sql);
importCSV("./data/cpu-sample.csv", "INSERT INTO CPU VALUES (?,?,?,?,?,?)");
...
db.run(sql);
importCSV("./data/cpu-cooler-sample.csv", "INSERT INTO CPUCooler VALUES (?,?,?,?,?)");
...
db.run(sql);
importCSV("./data/motherboard-sample.csv", "INSERT INTO Motherboard VALUES (?,?,?,?,?)");
...
db.run(sql);
importCSV("./data/memory-sample.csv", "INSERT INTO Memory VALUES (?,?,?,?,?,?,?,?)");
...
db.run(sql);
importCSV("./data/case-sample.csv", "INSERT INTO ProdCase VALUES (?,?,?,?,?,?,?)");
...
db.run(sql);
importCSV("./data/psu-sample.csv", "INSERT INTO PSU VALUES (?,?,?,?,?,?)");
...
db.run(sql);
importCSV("./data/gpu-sample.csv", "INSERT INTO GPU VALUES (?,?,?,?,?,?,?)");
...
db.run(sql);
importCSV("./data/storage-sample.csv", "INSERT INTO Storage VALUES (?,?,?,?,?,?,?)");
}
