...
export class InventoryComponent {
  ...
  ngOnInit(): void {
    ...
    this.columns = [
      { title: 'Model NO.', index: 'model_no', className: 'text-left', sort: true },
      { title: 'Name', index: 'name', className: 'text-left', width: '420px', sort: true },
      { title: 'Manufacture', index: 'manufacture', className: 'text-left', sort: true },
      { title: 'Price', index: 'retail_price', className: 'text-left', width: '120px', sort: true },
      { title: 'Qtty', index: 'stock_qtty', type: 'number', width: '80px', className: 'text-center', sort: true }
    ];
  }

  addNewProduct(): void {
    this.newProductDrawer = true;
  }

  closeNewProductDrawer(): void {
    this.newProductDrawer = false;
  }
}
